...
3. #### Fase de maturação
	...
	A partir da **puberdade**, a **degeneração folicular mantém-se** e iniciam-se os **[[#^2c7269|ciclos ováricos]]**. Em cada ciclo, a meiose é reiniciada em vários folículos, mas apenas num deles o oócito I completa a **meiose I**, originando **2 células haploides resultantes de uma citocinese assimétrica**:
	...
	Caso **não ocorra fecundação**, o **corpo lúteo regride**, deixando uma pequena cicatriz no ovário. ^b92b9b
