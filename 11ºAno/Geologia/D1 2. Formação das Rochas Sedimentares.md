...
A ação da meteorização química é **mais intensa e facilitada** quanto **maior for o estado de desagregação física das rochas** e em **regiões quentes e húmidas**, já que a **temperatura** tem um papel importante na **velocidade** e dinâmica das **reações químicas** que se efetuam.
