...
- ##### Bioedificação (forma calcário recifal)
	Resultante da atividade de seres vivos, nomeadamente **corais**, que **constroem estruturas calcárias** através da **fixação do carbonato de cálcio dissolvido nas águas marinhas**.
- ##### Bioacumulação (forma calcário conquífero e diatomito)
	Resultante da **acumulação de porções inorgânicas de seres vivos**, como **conchas de moluscos** (no caso do calcário conquífero), ou de **carapaças siliciosas de diatomáceas** (no caso do diatomito).
