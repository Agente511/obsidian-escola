...
- ##### Bioedificação (forma calcário recifal)
	Resultante da atividade de seres vivos, nomeadamente **corais**, como os espongiários, que **constroem estruturas calcárias** através da **fixação do carbonato de cálcio dissolvido nas águas marinhas**.
- ##### Bioacumulação (forma calcário conquífero e diatomito)
	Resultante da **acumulação de porções inorgânicas de seres vivos**.
	No caso dos **calcários conquíferos**, são porções de **conchas de moluscos**, enquanto no caso do **diatomito**, são de **carapaças siliciosas de diatomáceas**.

Além disso, a **bioacumulação** de **porções orgânicas de seres vivos específicos** podem **evoluir**, **ao longo do tempo geológico** para **depósitos ricos em carbono**, formando **carvões** e **hidrocarbonetos**.
#### Carvão
