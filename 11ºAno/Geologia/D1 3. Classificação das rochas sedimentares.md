...
#### Classificação de rochas sedimentares detríticas
- ##### Travertino
	Forma-se por diagénese dos minerais de **calcite**, quimicamente **carbonato de cálcio** ($CaCO_3$), que **precipita** a partir de sedimentos químicos/iónicos, através da expressão: $$Ca^{2+}+2HCO^-_3 \longrightarrow CaCO_3+H_2O+CO_2$$
