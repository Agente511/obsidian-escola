...
> [!NOTE] Exemplo de caso de sobre-exploração de um aquífero
> Se um aquífero, no **litoral**, for **explorado em excesso**, a **diminuição da quantidade de água doce** possibilita o **avanço da água salgada subterrânea em direção ao continente**, acabando por **atingir as captações mais próximas do mar**.
