...
> [!Exemplo] Exemplo 1 de isomorfismo - Olivinas
...
>[!Note] Exemplo 2 de isomorfismo - Série contínua de Bowen
>Na série contínua de Bowen, a **estrutura cristalina mantém-se a mesma** na passagem de um mineral da série para outro. **Varia apenas a composição química**, pela **substituição gradual dos átomos de cálcio por átomos de sódio**, que permite obter os 
### Polimorfismo
