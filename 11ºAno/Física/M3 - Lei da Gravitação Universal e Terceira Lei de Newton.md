## Conceito de força
As forças traduzem **interações entre corpos**. As forças aparecem sempre aos **pares**, não havendo forças isoladas.

A unidade SI é o newton, N. A intensidade das forças mede-se com um dinamómetro.
>[!Example] Caracterização do força, como uma grandeza vetorial
>- **Ponto de aplicação**: ponto onde a força atua
>- **Direção**: a da reta segundo a qual a força atua (linha de ação da força)
>- **Sentido**: a orientação da força
>- **Intensidade**: módulo da força, acompanhado da respetiva unidade
### Interações
**Ações recíprocas** entre 2 corpos.
#### Interações de contacto
Forças que **requerem contacto direto** para serem aplicadas (no entanto, a nível microscópio, as partículas que constituem os corpos que exercem estas forças atuam à distância). 
>[!Note] Exemplos
>- Colisão de 2 automóveis
>- Chutar uma bola
#### Interações à distância
Forças que **não requerem contacto direto** para serem aplicadas.
>[!Note] Exemplos
>- Interação entre a Terra e um satélite.
>- Interação entre um íman e um frigorífico.
## Quatro interações fundamentais na Natureza
...
>- Movimento das marés;
>- Queda de corpos à superfície da Terra;
>- Existência de atmosfera na Terra.
### Força eletromagnética
Exerce-se entre **partículas com carga elétrica**. Engloba a força elétrica e a força magnética. Pode ser atrativa ou repulsiva.
- **Alcance infinito**
- **Mais intensa que a força gravítica** ($10^{2}$ vezes menor que a nuclear forte)
>[!Note] Exemplo
>- Ligações químicas
>- Formação dos átomos
>- Levitação de comboios (por exemplo, o Maglev)
>- Funcionamento de aceleradores de partículas
>- Exames de diagnóstico médico
>- Tratamentos por radioterapia
### Força nuclear forte
Responsável por **manter os protões e os neutrões unidos** no interior do núcleo atómico.
- **Alcance $10^{-15}$m** (no interior do núcleo)
- Força de **maior intensidade relativa** das quatro forças fundamentais
### Força nuclear fraca
Responsável pela **transformação de certos núcleos atómicos noutros núcleos atómicos**, em que o neutrão se transforma num protão e num eletrão.
- **Alcance $10^{-18}$m** (no interior do núcleo)
- **Menos intensa que a força nuclear forte** ($10^5$ vezes menor que a nuclear forte)
>[!Note] Exemplo
>- Transformação de hidrogénio em hélio, no Sol.
...
Como as forças traduzem interações, se a **Terra atrair uma bola** com uma força $\vec F_{Terra/bola}$ (peso, $\vec P$, da bola na Terra), simultaneamente a **bola atrai a Terra** com uma força $\vec F_{bola/Terra}$ que tem o **mesmo módulo e direção**, mas **sentido contrário**.
