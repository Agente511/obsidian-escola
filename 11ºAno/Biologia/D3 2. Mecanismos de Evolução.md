...
A **evolução divergente**, que conduz à **formação de estruturas homólogas**, ocorre quando **populações do mesmo organismo se separam**, por exemplo, geograficamente, ficando **sujeitas a diferentes pressões ambientais** que **favorecem as características com vantagens adaptativas** ao novo ambiente, formando **novas espécies** que **partilham um ancestral comum**.
^ onde pôr?
