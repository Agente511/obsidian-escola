*(a partir da pág. 57)*
## Equações do tipo $\sin x= a$
### Modo geral
![[Pasted image 20241127214033.png|300]]
$$\begin{flalign}& \ \ \ \ \ \ \ \ \ \ \sin(x)=a &\end{flalign}$$
$$\begin{flalign}& \iff \sin(x) = \sin(\alpha) &\end{flalign}$$
$$\begin{flalign}& \iff x=\alpha+2k\pi \lor x=\pi-\alpha+2k\pi, k \in\mathbb R &\end{flalign}$$


>[!Note] Exemplos
>1. $$\begin{flalign}&\ \ \ \ \ \ \ \ \ \  1+8 \sin(x)=-3 &\end{flalign}$$
>   $$\begin{flalign}& \iff 8 \sin(x)=-3-1 &\end{flalign}$$
>   $$\begin{flalign}& \iff 8 \sin(x)=-4 &\end{flalign}$$
>   $$\begin{flalign}& \iff \sin(x)=\frac {-4} 8 &\end{flalign}$$
>   $$\begin{flalign}& \iff \sin(x)=-\frac 1 2 &\end{flalign}$$
>   $$\begin{flalign}& \iff x=-\frac \pi 6+2k\pi \lor x=\pi + \frac{\pi} 6 +2k\pi, k\in \mathbb Z &\end{flalign}$$
>   $$\begin{flalign}& \iff x=-\frac \pi 6+2k\pi \lor x=\frac {7\pi} 6 +2k\pi, k\in \mathbb Z &\end{flalign}$$
>![[Pasted image 20241127201153.png|300]]
>2. $$\begin{flalign}&\ \ \ \ \ \ \ \ \ \  4 \sin (3x)-\sqrt 12=0 &\end{flalign}$$
>   $$\begin{flalign}& \iff 4 \sin (3x) = \sqrt {12} &\end{flalign}$$
>   $$\begin{flalign}& \iff \sin(3x)=\frac {2\sqrt 3} 4 &\end{flalign}$$
>   $$\begin{flalign}& \iff \sin(3x) = \frac {\sqrt 3} 2 &\end{flalign}$$
>   $$\begin{flalign}& \iff 3x=\frac \pi 3 +2k\pi \lor 3x= \pi-\frac \pi 3 + 2k\pi, k\in \mathbb Z &\end{flalign}$$
>   $$\begin{flalign}& \iff x = \frac \pi 9 + \frac {2k\pi} 3 \lor 3x=\frac {2\pi} 3 + 2k\pi, k\in \mathbb Z &\end{flalign}$$
>   $$\begin{flalign}& \iff x=\frac \pi 9 +\frac {2k\pi} 3 \lor x= \frac {2\pi} 9 +\frac {2k\pi} 3,k\in \mathbb Z &\end{flalign}$$
>3. $$\begin{flalign}& \ \ \ \ \ \ \ \ \ \  \sin(2x)=\sin(x) &\end{flalign}$$
>   $$\begin{flalign}& \iff 2x= x+2k\pi \lor 2x= \pi-x+2k\pi, k\in \mathbb Z &\end{flalign}$$
>   $$\begin{flalign}& \iff 2x-x=2k\pi \lor 2x+x=\pi + 2k\pi, k\in \mathbb Z &\end{flalign}$$
>   $$\begin{flalign}& \iff x=2k\pi \lor 3x=\pi+2k\pi, k\in \mathbb Z &\end{flalign}$$
>4. $$\begin{flalign}& \ \ \ \ \ \ \ \ \ \ \sin(x+\frac \pi 4) = \cos (\frac x 3) &\end{flalign}$$
>   $$\begin{flalign}& \iff \sin(x+\frac \pi 4)= \sin(\frac \pi 2+\frac x 3) &\end{flalign}$$
>   $$\begin{flalign}& \iff x+\frac \pi 4=\frac \pi 2+\frac x 3+2k\pi \lor x+\frac \pi 4=\pi-(\frac \pi 2+\frac x 9)+2k\pi,k\in \mathbb Z &\end{flalign}$$
>   $$\begin{flalign}& \iff x-\frac x 3=\frac \pi 2-\frac \pi 4 +2k\pi \lor x+\frac \pi 4= \pi-\frac \pi 2-\frac x 3+2k\pi,k\in \mathbb Z &\end{flalign}$$
>   $$\begin{flalign}& \iff \frac {2x} 3 \frac \pi 4+2k\pi \lor x +\frac x 3 =\frac \pi 2 - frac \pi 4+2k\pi, k\in \mathbb Z& \end{flalign}$$
>   $$\begin{flalign}& \iff x=\frac 3 2 \times \frac \pi 4 + \frac 3 2 \times 2k\pi \lor \frac {4x} 3 x =\frac \pi 4 + 2k\pi, k\in \mathbb Z&\end{flalign}$$
>   $$\begin{flalign}& \iff x=\frac {3\pi} 8+ 3k\pi \lor x = \frac {3\pi} {16} + \frac {3k\pi} 2, k \in \mathbb Z &\end{flalign}$$
### Casos particulares
#### $\sin(x)=1$ 
$$\begin{flalign}& \iff x=\frac \pi 2 + 2k\pi, k\in \mathbb Z &\end{flalign}$$
#### $\sin(x)=-1$
$$\begin{flalign}& \iff x =-\frac \pi 2+2k\pi, k\in \mathbb Z &\end{flalign}$$
$$\begin{flalign}& \iff x=\frac {3\pi} 2 +2k\pi, k\in \mathbb Z &\end{flalign}$$
#### $\sin(x)=0$ 
$$\begin{flalign}& \iff x=0+2k\pi \lor x=\pi+2k\pi,k\in \mathbb Z &\end{flalign}$$
$$\begin{flalign}& \iff x=k\pi, k\in \mathbb Z &\end{flalign}$$
>[!Note] Exemplos de casos particulares
>$$\begin{flalign}& 2\sin^2(x)=3\sin(x)-1 &\end{flalign}$$
>$$\begin{flalign}& 2\sin^2(x)-3\sin(x)+1=0 &\end{flalign}$$
>
>M.V. $$\begin{flalign}& y=\sin(x) &\end{flalign}$$
>$$\begin{flalign}& 2y^2-3y+2=0 &\end{flalign}$$
...
>    $$\begin{flalign}& \iff x+\frac \pi 5 = \frac {9\pi} {10} + 2k\pi \lor x+\frac \pi 5=-\frac {9\pi} {10}+2k\pi,k \in \mathbb Z &\end{flalign}$$
