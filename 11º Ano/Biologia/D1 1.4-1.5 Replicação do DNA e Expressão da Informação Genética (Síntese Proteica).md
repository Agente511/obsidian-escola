...
- Os tripletos **UAA**, **UGA** e **UAG** são **codões de finalização** (quando surgem, termina a síntese) ^9fa8cc
...
>- Quando a mutação conduz ao fim prematuro da síntese trata-se de uma mutação **nonsense**.
...
As mutações podem **ocorrer espontaneamente durante a replicação do DNA** ou serem **induzidas por exposição a determinadas radiações ou substâncias químicas**. Os agentes que podem interagir com o DNA causando mutações são designados **agentes mutagénicos**.
