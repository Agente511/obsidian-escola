Para que a coerência do discurso seja mantida é necessária garantir também a sua coesão.
...
### Coesão referencial
#### Anáfora
Mecanismo de ligação assente na existência de cadeias anafóricas, constituídas por um **antecedente** (referente) que é **retomado por termos anafóricos** (termos correferentes) cujo entendimento só é possível atendendo ao significado do antecedente.
O **referente** surge **antes** dos **termos correferentes**.
>[!Note] Exemplo
